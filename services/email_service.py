...
from config.settings import (
    LOGS_DIR, ASSETS_DIR, MES_ANO_EXTENSO, EMAIL_DESTINATARIO,
...
arquivo_log = LOGS_DIR / f"execucao_{datetime.now().strftime('%Y_%m_%d_%H-%M')}.log"
    ...
    if not lista_imagens and not caminho_pptx:
        ...
        <html>
            <body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
                ...
                <p>Boa tarde, Priscila! Tudo bem?</p>
                <p>Esse é o e-mail modelo que você irá receber sobre os dados analisados relativos aos recursos humanos, atualmente conta somente com os dados sobre o absenteismo, como conversamos!</p>
        ...
        caminho_contato = ASSETS_DIR / "cabecalho_rodape.png"
        caminho_logo = ASSETS_DIR / "logo_rodape.png"
