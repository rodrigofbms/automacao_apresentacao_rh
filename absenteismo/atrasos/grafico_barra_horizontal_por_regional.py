...
def gerar_grafico(conexao,
    ...
    nome_arquivo_saida = pasta_graficos / f"atrasos_absenteismo_por_regional_{mes_ano_filtro}.png"
    ...
    df = pd.read_sql(SCRIPTS_SQL["atrasos_por_regional"], conexao, params=[data_inicio_sql, data_fim_sql])
    ...
    if df.empty:
        ...
        plt.xlabel('Total de Horas', fontsize=10, weight='bold', labelpad=10)
        plt.ylabel('Regional', fontsize=10, weight='bold', labelpad=10)
