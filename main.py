...
from config.settings import (
    BASE_DIR, GRAFICOS_DIR, LOGS_DIR, APRSENTACOES_DIR, DATA_INICIO_SQL, DATA_FIM_SQL, 
...
# ---------------------------------------------------------
from absenteismo.geral.grafico_linha_absenteismo_por_mes import gerar_grafico as geral_linha_absenteismo_por_mes
from absenteismo.geral.grafico_donut_horas_absenteismo import gerar_grafico as geral_donut_horas_absenteismo
from absenteismo.geral.grafico_barra_vertical_horas_absenteismo import gerar_grafico as geral_grafico_barra_vertical_horas_absenteismo

from absenteismo.faltas.grafico_barra_horizontal_por_centro_custo import gerar_grafico as faltas_barra_horizontal_por_centro_custo
from absenteismo.faltas.cards_por_mes import gerar_grafico as faltas_cards_por_mes

from absenteismo.atrasos.grafico_barra_horizontal_por_centro_custo import gerar_grafico as atrasos_grafico_barra_horziontal_por_centro_custo
#from atrasos.grafico_barra_horizontal_por_regional import gerar_grafico as atrasos_grafico_barra_horizontal_por_regional
from absenteismo.atrasos.cards_por_mes import gerar_grafico as atrasos_cards_por_mes

from absenteismo.atestados.cards_por_mes import gerar_grafico as atestados_cards_por_mes
from absenteismo.atestados.grafico_barra_horizontal_por_centro_custo import gerar_grafico as atestados_grafico_barra_horizontal_por_centro_custo
from absenteismo.atestados.grafico_barra_vertical_custo_atestados_por_centro_custo import gerar_grafico as atestados_grafico_barra_vertical_custo_atestados_por_centro_custo
from absenteismo.atestados.grafico_linha_custo_atestados_por_mes import gerar_grafico as atestados_grafico_linha_custo_atestados_por_mes
...
if __name__ == "__main__":
    ...
    # '*' é um operador para desempactar uma lista e inserir cada item dessa lista como um único item nessa nova lista
